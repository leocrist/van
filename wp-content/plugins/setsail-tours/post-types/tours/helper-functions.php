		...
		foreach ( $sections_array as $section ) {
			...
			switch ( $section_key ) {
				case 'show_info_section' :
					$return_array[ $section_key ]['title'] = esc_html__( 'ÜBERBLICK', 'setsail-tours' );
					$return_array[ $section_key ]['id']    = 'tour-item-info-id';
					break;
				case 'show_plan_section' :
					$return_array[ $section_key ]['title'] = esc_html__( 'PROGRAMM', 'setsail-tours' );
				...
				case 'show_location_section' :
					$return_array[ $section_key ]['title'] = esc_html__( 'KARTE', 'setsail-tours' );
					$return_array[ $section_key ]['id']    = 'tour-item-location-id';
					break;
				case 'show_gallery_section' :
					$return_array[ $section_key ]['title'] = esc_html__( 'GALERIE', 'setsail-tours' );
